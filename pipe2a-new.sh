...
jid3=$(sbatch /data/src/PyHipp/rs1a-slurm.sh)
jid4=$(sbatch /data/src/PyHipp/rs2a-slurm.sh)
jid5=$(sbatch /data/src/PyHipp/rs3a-slurm.sh)
jid6=$(sbatch /data/src/PyHipp/rs4a-slurm.sh)
